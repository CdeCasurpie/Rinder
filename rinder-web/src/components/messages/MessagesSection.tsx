                  ...
                  <Image
                    src={
                      chat.otherUser?.ruta_photo
                        ? `/assets/profilePhotos/${chat.otherUser.other_id}/${chat.otherUser.ruta_photo}`
              ...
              <Image
                src={
                  activeChat.otherUser.ruta_photo
                    ? `/assets/profilePhotos/${activeChat.otherUser.other_id}/${activeChat.otherUser.ruta_photo}`
                    : '/assets/images/fondo1.JPG'
                }
                alt="Foto de perfil"
                width={150}
